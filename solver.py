...
def compute_mwps(feature_model):
    """Compute Minimum Working Products from the feature model."""
    ...
    def identify_mandatory_features(model):
        """Get all mandatory features and their relationships."""
        mandatory = set()
        
        def process_feature(feature, is_mandatory_branch):
            # If we're in a mandatory branch and this feature is mandatory
